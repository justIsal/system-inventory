...
interface CatalogToolbarProps {
  ...
  sortOptions?: { label: string; key: string; order: 'asc' | 'desc' }[];
      ...
      <div className="flex items-center gap-3 relative">
                ...
                <div>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        onFilterChange?.({ ...currentFilters, inStock: e.target.checked })
                      }
                    />
            ...
            <div className="mt-4 pt-3 border-t flex justify-end">
              <button
                ...
                onClick={() =>
                  onResetFilter
                    ? onResetFilter()
                    : onFilterChange?.({ category: undefined, inStock: false })
                }
        ...
        {isSortOpen && (
          <div className="absolute top-12 left-[100px] w-56 bg-white border border-gray-200 rounded-lg drop-shadow-xl z-10 py-2">
            {(sortOptions || defaultSortOptions).map((opt) => {
